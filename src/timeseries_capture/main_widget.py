    ...
    def _on_recording_status_updated(self, status: dict):
        ...
        try:
            ...
            rec_status = {
                ...
                "cumulative_drift_sec": status.get("cumulative_drift_sec", 0.0),
                "last_actual_interval_sec": status.get("last_actual_interval_sec", float("nan")),
            }
            ...
            def run_calibration():
                ...
                try:
                    ...
                    calibrator = CalibrationService(
                        ...
                        saturation_limit_percent=self.led_panel.get_saturation_limit_percent(),
                    )
